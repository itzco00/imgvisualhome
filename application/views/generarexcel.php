...
?>
    ...
    //header("Content-Disposition: attachment; filename=$cos->numordencompra2$cos->id.xls");
    header("Content-Disposition: attachment; filename=$cos->tienda ALBERTO.xls");
...
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"><!--Importante este charset dejarlo como si fuera html el iso es solo para generar el excel-->
    <style>
        /*
        body{
...
<body>
    ...
    <table class="table" style="background-color: #B2B2B2; border-right: 1px solid; border-left: 1px solid">
        <tr>
            ...
            <th colspan="2">
                ...
                foreach ($centrocostos3 as $cos) {
                ?>
                    FECHA DE ENTREGA: <?= $cos->fecha_entrega ?>
                <?php
                }
                ?>
            </th>
    ...
    <table class="table" style="border-right: 1px solid; border-left: 1px solid">
        ...
        <tr>
            ...
            <th style="text-align: center; color: black; font-size: 1.2em; background-color: #FFBD00;" colspan="3">INSTALACION Y TRANSPORTE</th>
            <td style="text-align: center; color: black; font-size: 1.2em; background-color: #ffffff;" colspan="2">
                <?php
                foreach ($centrocostos3 as $cos) {
                ?>
                    $<?= $cos->totalinstalacionytransporte ?> MXN
                <?php
                }
                ?>
            </td>
            <td style="text-align: center; color: black; font-size: 1.2em; background-color: #ffffff;">
                ...
                foreach ($centrocostos3 as $cos) {
                ?>
                    <?= $cos->porcentajeinstalacionytransporte ?> %
                <?php
                }
                ?>
            </td>
        ...
        <tr>
            <th style="text-align: center; color: white; font-size: 1.2em; background-color: #000000;" colspan="1"></th>
            <th style="text-align: center; color: black; font-size: 1.2em; background-color: #D6D6D6;" colspan="3">
                <?php
                foreach ($centrocostos3 as $cos) {
                ?>
                    M2 TIENDA <?= $cos->m2 ?>
            ...
            <td style="text-align: center; color: black; font-size: 1.2em; background-color: #ffffff;" colspan="2">
                ...
                foreach ($centrocostos3 as $cos) {
                ?>
                    $<?= $cos->totalmueblesherrajesextrasinstalacionytransportepopmaniquis ?> MXN
                <?php
                }
                ?>
            </td>
            <td style="text-align: center; color: black; font-size: 1.2em; background-color: #ffffff;">
                ...
                foreach ($centrocostos3 as $cos) {
                ?>
                    $<?= $cos->totalmueblesherrajesextras ?> MXN
                <?php
                }
                ?>
            </td>
        ...
        <tr style="border-bottom: 1px solid">
            ...
            <td style="text-align: center; color: black; font-size: 1.2em; background-color: #D6D6D6;" colspan="2">
                ...
                foreach ($centrocostos3 as $cos) {
                ?>
                    $<?= $cos->totalentrevalorantespreciototalv1 ?> MXN
                <?php
                }
                ?>
            </td>
            <td style="text-align: center; color: black; font-size: 1.2em; background-color: #D6D6D6;">
                ...
                foreach ($centrocostos3 as $cos) {
                ?>
                    $<?= $cos->totalentrevalorantespreciototal2v2 ?> MXN
                <?php
                }
                ?>
            </td>
    ...
    <?php else : ?>
        <table class="table" style="border-right: 1px solid; border-left: 1px solid; border-top: 1px solid;">
            <tr>
                <th colspan="7" style="text-align: center; color: black; font-size: 1.7em; background-color: #B0B0B0;">10.0 EXTRAS</th>
            </tr>
            <tr>
                <th colspan="4" style="text-align: left; color: black; font-size: 1.3em; background-color: #D8D8D8;">MOBILIARIO DE PISO</th>
                <th style="text-align: center; color: black; font-size: 1.5em; background-color: #D8D8D8;">TOTAL</th>
                ...
                foreach ($subtotales3 as $sub) {
                ?>
                    <td style="font-size: 1.5em; background-color: #83EC81; color: black">$<?= $sub->finalextmpi ?> MXN</td>
                <?php
                }
                ?>
                <th style="text-align: center; color: black; font-size: 1.5em; background-color: #D8D8D8;"></th>
    ...
    <?php endif ?>
    <?php if ($imgpop3 == '' && $imgmaniquis3 == '') : ?>
    <?php else : ?>
        <table class="table" style="border-right: 1px solid; border-left: 1px solid; border-top: 1px solid;">
            <tr>
                <th colspan="7" style="text-align: center; color: black; font-size: 1.7em; background-color: #B0B0B0;">11.0 IMAGEN</th>
            </tr>
            <?php if ($imgpop3 == '') : ?>
            <?php else : ?>
                <tr>
                    <th colspan="4" style="text-align: center; color: black; font-size: 1.7em; background-color: #D8D8D8;"></th>
                    <th style="text-align: center; color: black; font-size: 1.3em; background-color: #D8D8D8;">TOTAL</th>
                    <?php
                    foreach ($subtotales3 as $sub) {
                    ?>
                        <td style="font-size: 1.5em; background-color: #B84EED; color: black">$<?= $sub->finalimgp ?> MXN</td>
                    <?php
                    }
                    ?>
                    <th style="text-align: center; color: black; font-size: 1.5em; background-color: #D8D8D8;"></th>
            ...
            <?php else : ?>
                <tr>
                    ...
                    foreach ($subtotales3 as $sub) {
                    ?>
                        <td style="font-size: 1.5em; background-color: #FDFF78; color: black">$<?= $sub->finalimgm ?> MXN</td>
                    <?php
                    }
                    ?>
                    <th style="text-align: center; color: black; font-size: 1.5em; background-color: #D8D8D8;"></th>
    ...
    <?php else : ?>
        <table class="table" style="border-right: 1px solid; border-left: 1px solid; border-top: 1px solid;">
            <tr>
                <th colspan="4" style="text-align: center; color: black; font-size: 1.7em; background-color: #B0B0B0;">12.0 OTROS</th>
                <th style="text-align: center; color: black; font-size: 1.5em; background-color: #B0B0B0;">TOTAL</th>
                <?php
                foreach ($subtotales3 as $sub) {
                ?>
                    <td style="font-size: 1.5em; background-color: #4449F3; color: white">$<?= $sub->finalots ?> MXN</td>
                <?php
                }
                ?>
                <th style="text-align: center; color: black; font-size: 1.5em; background-color: #B0B0B0;"></th>
    ...
    <table class="table" style="border: 1px solid;">
        <thead>
            <tr>
                ...
                ?>
                    <th style="text-align: left; color: white; font-size: 1.5em; background-color: #000000;">$<?= $cosf->totalmueblesherrajesextrasinstalacionytransportepopmaniquis3 ?> MXN</th>
                <?php
                }
                ?>
            </tr>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td style="text-align: left; color: black; background-color: #ffffff;">$<?= $cosf->totalmueblesherrajesextrasinstalacionytransportepopmaniquis3 ?> MXN<input type="hidden" size="15" style="font-size: 1.5em; color: black" id="totalmueblesherrajesextrasinstalacionytransportepopmaniquis3v2" value="<?= $cosf->totalmueblesherrajesextrasinstalacionytransportepopmaniquis3 ?>" readonly></td>
                    <td style="text-align: left; color: black; background-color: #ffffff;">$<?= $cosf->anticipo ?> MXN<input type="hidden" size="15" style="font-size: 1.5em; color: black" id="anticipov2" value="<?= $cosf->anticipo ?>" readonly></td>
                </tr>
            <?php
            }
            ?>
            <tr>
                ...
                <td style="text-align: left; color: black; background-color: #ffffff;">$<?= $cosf->totalconiva ?> MXN<input type="hidden" size="15" style="font-size: 1.5em; color: black" id="totalconivav2" value="<?= $cosf->totalconiva ?>" readonly></td>
                <td style="text-align: left; color: black; background-color: #ffffff;">$<?= $cosf->anticipoconiva ?> MXN<input type="hidden" size="15" style="font-size: 1.5em; color: black" id="anticipoconivav2" value="<?= $cosf->anticipoconiva ?>" readonly></td>
            </tr>
            <tr>
                <td style="background-color: #ffffff;"></td>
                <td style="background-color: #ffffff;"></td>
                ...
                <td style="text-align: left; color: black; background-color: #ffffff;">$<?= $cosf->totaltiendav2 ?> MXN<input type="hidden" size="15" style="font-size: 1.5em; color: black" id="totaltienda" value="<?= $cosf->totaltiendav2 ?>" readonly></td>
                <td style="text-align: left; color: black; background-color: #ffffff;">$<?= $cosf->totaltiendaanticipov2 ?> MXN<input type="hidden" size="15" style="font-size: 1.5em; color: black" id="totaltiendaanticipo" value="<?= $cosf->totaltiendaanticipov2 ?>" readonly></td>
            </tr>
            <tr>
                <td style="background-color: #ffffff;"></td>
                <td style="background-color: #ffffff;"></td>
            ...
            <tr>
                ...
                <td style="background-color: #ffffff;"></td>
                <?php
                foreach ($centrocostos3 as $cos3) {
                ?>
                    <td style="text-align: left; color: black; background-color: #ffffff;"><?= $cos3->m2 ?><input type="hidden" size="15" style="font-size: 1.5em; color: black" id="mismom2inicio" value="500.72" readonly></td>
                <?php
                }
                ?>
                <td style="text-align: left; color: black; background-color: #ffffff;">$<?= $cosf->m2tiendafinalv2 ?> MXN<input type="hidden" size="15" style="font-size: 1.5em; color: black" id="m2tiendafinal" value="<?= $cosf->m2tiendafinalv2 ?>" readonly></td>
            </tr>
            <tr>
                <td style="background-color: #ffffff;"></td>
                <td style="background-color: #ffffff;"></td>
                ...
                <td style="text-align: left; color: black; background-color: #ffffff;">$<?= $cosf->finiquitov2 ?> MXN<input type="hidden" size="15" style="font-size: 1.5em; color: black" id="finiquito" value="<?= $cosf->finiquitov2 ?>" readonly></td>
            </tr>
        </tbody>
    </table>
</body>
